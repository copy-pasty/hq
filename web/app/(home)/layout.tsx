import { ArrowSquareOut, ArrowSquareUp } from "@phosphor-icons/react/dist/ssr";
    ...
    <>
      <header className="m-6 flex flex-wrap justify-between gap-2">
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            <div className="flex items-center justify-end gap-2">
              <Link
                ...
                target="_blank"
                className="flex h-10 w-11 items-center justify-center rounded-lg bg-neutral-800 text-neutral-400 hover:bg-neutral-700 hover:text-white focus:bg-neutral-700 focus:text-white"
              >
                𝕏
              </Link>
        ...
        <ul className="flex gap-2">
          <li>
            <Link
              href="https://github.com/copy-pasty/hq/issues/new"
              target="_blank"
              className="flex h-10 items-center justify-center gap-1 rounded-lg bg-neutral-800 px-3 text-sm text-neutral-400 hover:bg-neutral-700 hover:text-white focus:bg-neutral-700 focus:text-white"
            >
              file an issue
              <ArrowSquareOut />
            </Link>
          ...
          <li>
            <Link
              href="https://github.com/copy-pasty/hq/discussions/new?category=suggestions-feedback"
              target="_blank"
              className="flex h-10 items-center justify-center gap-1 rounded-lg bg-neutral-800 px-3 text-sm text-neutral-400 hover:bg-neutral-700 hover:text-white focus:bg-neutral-700 focus:text-white"
            >
              suggest
